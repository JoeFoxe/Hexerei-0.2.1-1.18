...
public class OwlPostOfficeStructure extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<OwlPostOfficeStructure> CODEC = RecordCodecBuilder.<OwlPostOfficeStructure>mapCodec(instance ->
            instance.group(OwlPostOfficeStructure.settingsCodec(instance),
            ...
            ).apply(instance, OwlPostOfficeStructure::new)).codec();
    ...
    public OwlPostOfficeStructure(StructureSettings config,
    ...
    public StructureType<?> type() {
        return ModStructures.OWL_POST_OFFICE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}