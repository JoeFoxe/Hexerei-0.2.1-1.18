...
public class BabaYagaHutStructure extends Structure {
    ...
    public static final Codec<BabaYagaHutStructure> CODEC = RecordCodecBuilder.<BabaYagaHutStructure>mapCodec(instance ->
            instance.group(BabaYagaHutStructure.settingsCodec(instance),
            ...
            ).apply(instance, BabaYagaHutStructure::new)).codec();
    ...
    public BabaYagaHutStructure(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!BabaYagaHutStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.BABA_YAGA_HUT.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}