...
public class CustomItemRenderer {
    ...
    protected class Renderer extends BlockEntityWithoutLevelRenderer {
        ...
        @OnlyIn(Dist.CLIENT)
        @Override
        public void renderByItem(ItemStack stack, ItemDisplayContext pDisplayContext, PoseStack poseStack, MultiBufferSource multiBufferSource, int light, int overlay) {
