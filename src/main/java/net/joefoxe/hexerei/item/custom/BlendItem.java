...
public class BlendItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        if(Screen.hasShiftDown()) {
            ...
            tooltipComponents.add(Component.translatable("tooltip.hexerei.blend_item_shift").withStyle(Style.EMPTY.withColor(TextColor.fromRgb(0x999999))));
        } else {
...
//            tooltip.add(Component.translatable("tooltip.hexerei.blend_item"));
        }
