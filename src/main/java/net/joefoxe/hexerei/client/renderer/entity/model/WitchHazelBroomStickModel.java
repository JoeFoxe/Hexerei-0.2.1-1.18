...
public class WitchHazelBroomStickModel extends ListModel<BroomEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(HexereiUtil.getResource("witch_hazel_broom_stick"), "main");
    public static final ModelLayerLocation POWER_LAYER_LOCATION = new ModelLayerLocation(HexereiUtil.getResource("witch_hazel_broom_power_stick"), "main");
