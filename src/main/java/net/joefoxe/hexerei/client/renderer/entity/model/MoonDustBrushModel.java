...
public class MoonDustBrushModel extends ListModel<BroomEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(HexereiUtil.getResource("moon_dust_brush"), "main");
    public static final ModelLayerLocation POWER_LAYER_LOCATION = new ModelLayerLocation(HexereiUtil.getResource("moon_dust_brush_power"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        broom_brush.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
