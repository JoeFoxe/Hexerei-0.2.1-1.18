...
public class BroomStickBaseModel extends ListModel<BroomEntity> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation cube) {
        ...
        PartDefinition Broom = partdefinition.addOrReplaceChild("Broom", CubeListBuilder.create().texOffs(0, 0).addBox(-11.2131F, -3.9639F, -0.8505F, 25.0F, 2.0F, 2.0F, cube)
                .texOffs(28, 30).addBox(-21.6631F, -3.9739F, -1.2505F, 4.0F, 2.0F, 2.0F, cube), PartPose.offset(0.2131F, 24.9639F, -0.1495F));

        PartDefinition stick_r1 = Broom.addOrReplaceChild("stick_r1", CubeListBuilder.create().texOffs(0, 22).addBox(-15.548F, -4.01F, -1.6294F, 5.0F, 2.0F, 2.0F, cube), PartPose.offsetAndRotation(-1.5056F, 0.0361F, 5.2711F, 0.0F, -0.4363F, 0.0F));

        PartDefinition stick_r2 = Broom.addOrReplaceChild("stick_r2", CubeListBuilder.create().texOffs(30, 9).addBox(-17.398F, -4.0F, -2.4706F, 4.0F, 2.0F, 2.0F, cube), PartPose.offsetAndRotation(-1.7303F, 0.0361F, -6.1858F, 0.0F, 0.4363F, 0.0F));
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        broom_stick.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
