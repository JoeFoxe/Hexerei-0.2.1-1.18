...
public class OwlContainer extends AbstractContainerMenu {
    ...
    public OwlContainer(int windowId, OwlEntity owlEntity, Inventory playerInventory, Player player) {
        super(ModContainers.OWL_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        ...
        if (owlEntity == null || owlEntity.isRemoved()) {
            return false;
        } else {
            return !(playerIn.distanceToSqr(owlEntity) > 64.0D);
        }
    }
